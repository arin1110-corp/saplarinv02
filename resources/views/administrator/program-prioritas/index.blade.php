...
<body class="bg-slate-950 text-white">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.program-prioritas.export') }}"
                        class="bg-green-600 hover:bg-green-700 px-4 py-2 rounded-xl font-semibold">
                        Export Excel
                    </a>
            ...
            <div class="space-y-6">
                ...
                @forelse ($prioritas as $item)
                    @php
                        ...
                        $persenPrioritas =
                            $totalTargetPrioritas > 0 ? ($totalCapaianAktif / $totalTargetPrioritas) * 100 : 0;
                        ...
                        <div class="space-y-5">
                            ...
                            @forelse ($item->rencana as $rencana)
                                @php
                                    ...
                                    $persenRencana =
                                        $targetRencana > 0 ? ($capaianAktifRencana / $targetRencana) * 100 : 0;
                                    ...
                                    <div class="flex justify-between items-start gap-4 mb-4">
                                        <div>
                                            <div class="flex flex-wrap items-center gap-2">
                                                ...
                                                @else
                                                    <span
                                                        class="bg-red-600/20 text-red-300 px-3 py-1 rounded-full text-xs">
                                                        Nonaktif
                                                    </span>
                                                @endif

                                                <span
                                                    class="bg-blue-600/20 text-blue-300 px-3 py-1 rounded-full text-xs">
                            ...
                            @empty
                                <div
                                    class="border border-dashed border-slate-700 rounded-2xl p-6 text-center text-slate-500">
    ...
    @include('administrator.program-prioritas.partials.modal')
