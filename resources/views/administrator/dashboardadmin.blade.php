...
<body>
    <div class="sidebar" style="background: #0b2e4e;">
        <div>
            <center>
                <div class="brand"><i class="bi bi-shield-lock-fill"></i> Admin</div>
            </center>
            <ul class="nav flex-column">
                <li><a class="nav-link navadmin active" href="#"><i class="bi bi-house"></i> Dashboard</a></li>
                <li><a class="nav-link navadmin" href="#"><i class="bi bi-people"></i> Pengguna</a></li>
            </ul>
        </div>
