    ...
    <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6">
        ...
        <div class="mt-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
                ...
                <select id="perPage"
                    class="rounded-xl border border-slate-200 px-3 py-2 bg-white text-slate-800">
    ...
    <div id="paguWrapper" class="space-y-6">
        ...
        @forelse ($pagus as $item)
            ...
            @php
                ...
                $persenSerapan = $item->spj_pagu_final > 0
                    ? ($totalRealisasi / $item->spj_pagu_final) * 100
                    : 0;
            ...
            <div class="pagu-card bg-white rounded-3xl border border-slate-200 shadow-sm p-6"
                ...
                <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-6">
                    ...
                    <button type="button"
                        onclick='openSPJModal(@json($item))'
    ...
    <div class="bg-white rounded-3xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto p-6">
        ...
        <form id="spjForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="spj_uraian"
                    rows="4"
                    class="w-full rounded-2xl border border-slate-200 px-4 py-3"
                    placeholder="Contoh: Pembayaran konsumsi rapat..."
                    required></textarea>
            </div>
