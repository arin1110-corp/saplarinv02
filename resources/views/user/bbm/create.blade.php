        ...
        <form method="POST" action="{{ route('user.bbm.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text"
                        value="{{ session('pegawai_nama') }}"
                        class="w-full rounded-2xl border border-slate-200 bg-slate-100 px-4 py-3"
                        readonly>
                </div>
            ...
            <div>
                ...
                <textarea name="bbm_uraian_kegiatan"
                    rows="5"
