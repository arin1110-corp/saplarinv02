        ...
        <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-6">
            ...
            <form method="POST" action="{{ route('user.bbm.store') }}" enctype="multipart/form-data" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="bbm_no_plat" value="{{ old('bbm_no_plat') }}"
                        class="w-full rounded-2xl border border-slate-200 px-4 py-3 uppercase focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Contoh: DK 1234 AB" required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="bbm_liter" step="0.01" min="0.01" value="{{ old('bbm_liter') }}"
                        class="w-full rounded-2xl border border-slate-200 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>
                </div>
                ...
                <div class="mb-4">
                    <label class="block text-sm font-semibold text-slate-700 mb-2">
                        Foto Mobil / Kendaraan
                    </label>

                    <input type="file" name="bbm_foto_mobil_file" accept="image/*"
                        class="w-full rounded-2xl border border-slate-200 px-4 py-3 bg-white" required>

                    <p class="text-xs text-slate-500 mt-2">
                        Upload foto kendaraan. Format JPG, JPEG, PNG, atau WEBP. Maksimal 5 MB.
                    </p>
                </div>
