...
@section('page-description', 'Kelola data program SAPLARIN')
...
@section('content')
    ...
    <div
        ...
        <div class="overflow-x-auto">
            ...
            <table id="programTable" class="min-w-full text-sm">
    ...
    <!-- MODAL TAMBAH -->
    <div id="programModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            ...
            <div class="flex items-center justify-between border-b border-slate-200 dark:border-slate-700 px-6 py-5">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        ...
                        Tambahkan data program SAPLARIN.
            ...
            <form method="POST" action="{{ route('admin.program.store') }}">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="program_kode"
                    ...
                    <div>
                        ...
                        <input type="text" name="program_nama"
                            class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3"
                            required>
            ...
            <form method="POST" action="{{ route('admin.program.update') }}">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" id="edit_program_kode" name="program_kode"
                            class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3"
                            required>
                    ...
                    <div>
                        ...
                        <input type="text" id="edit_program_nama" name="program_nama"
                            class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3"
                            required>
    ...
    @push('scripts')
        <script>
            ...
            function closeModal() {
                ...
                const form = document.querySelector('#programModal form');
            ...
            function openEditModal(program) {
                ...
                document.getElementById('edit_program_kode').value =
                    program.program_kode;

                document.getElementById('edit_program_nama').value =
                    program.program_nama;

                document.getElementById('edit_program_status').value =
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                ['programModal', 'editProgramModal'].forEach(function(id) {
    ...
    @push('styles')
        <style>
            #programTable_wrapper .dataTables_filter input {
            ...
            .dark #programTable_wrapper .dataTables_filter input {
            ...
            #programTable_wrapper .dataTables_length select {
            ...
            .dark #programTable_wrapper .dataTables_length select {
