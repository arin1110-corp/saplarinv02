            ...
            <tbody>
                ...
                <tr class="border-t border-slate-200 dark:border-slate-800">
                    ...
                    <td class="px-4 py-4 text-center">
                        ...
                        <button
                            onclick='openEditModal(@json($subkegiatan))'
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            name="sub_kegiatan_kode_rekening"
                            class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3"
                            required>
...
<div
    ...
    <div
        ...
        <form
            method="POST"
            action="{{ route('admin.subkegiatan.update') }}">

            @csrf

            <input
                type="hidden"
                id="edit_sub_kegiatan_id"
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            id="edit_sub_kegiatan_kode_rekening"
                            name="sub_kegiatan_kode_rekening"
                            class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3"
                            required>
