    ...
    <div
        ...
        <div
            ...
            <div class="text-sm text-slate-500">
                ...
                <b>{{ $kegiatans->firstItem() }}</b>

                -

                <b>{{ $kegiatans->lastItem() }}</b>
            ...
            <form method="POST" action="{{ route('admin.kegiatan.store') }}">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="kegiatan_nama"
                            class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3"
                            required>
                    ...
                    <div>
                        ...
                        <input type="text" name="kegiatan_kode"
                            class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3"
                            required>
            ...
            <form method="POST" action="{{ route('admin.kegiatan.update') }}">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <select id="edit_kegiatan_program" name="kegiatan_program"
                            class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3"
                            required>
                    ...
                    <div>
                        ...
                        <select id="edit_kegiatan_status" name="kegiatan_status"
                            class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-3"
                            required>
