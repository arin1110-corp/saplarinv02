...
@section('content')
        ...
        <form method="GET" action="{{ route('admin.laporan-spj.index') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div class="flex items-end">
                    ...
                    <button class="w-full rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-3">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6 mb-6">
        ...
        <div
            class="xl:col-span-2 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <form method="GET" class="mb-6">
                ...
                <div class="relative w-full md:w-96">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Cari Unit / Sub Kegiatan..."
                            ...
                            tooltip: {
                                ...
                                callbacks: {
                                    ...
                                    label: function(context) {
                                        ...
                                        const total = context.dataset.data.reduce((a, b) => Number(a) + Number(b),
                                            0);
