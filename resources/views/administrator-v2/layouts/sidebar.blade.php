                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="mt-2 space-y-1">
                        ...
                        <div x-data="{ open: false }">
                            ...
                            <button type="button" @click="open=!open"
                                class="w-full flex items-center justify-between rounded-xl px-5 py-3 hover:bg-slate-100 dark:hover:bg-slate-800 transition">
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="mt-2 space-y-1">
                        ...
                        <a href="{{ route('admin.permintaan.spj.buku-tamu') }}"
                            class="{{ request()->routeIs('admin.permintaan.spj.buku-tamu*')
                                ? 'bg-blue-50 dark:bg-slate-800 text-blue-600'
                                : 'text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800' }}
    flex items-center gap-3 rounded-lg px-5 py-2.5 transition">
