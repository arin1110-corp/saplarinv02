...
@push('styles')
    <style>
        #bbmTable_wrapper .dataTables_filter input {
        ...
        .dark #bbmTable_wrapper .dataTables_filter input {
        ...
        #bbmTable_wrapper .dataTables_length select {
        ...
        .dark #bbmTable_wrapper .dataTables_length select {
